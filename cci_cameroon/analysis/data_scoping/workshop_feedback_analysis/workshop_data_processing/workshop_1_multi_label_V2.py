...
# %%
final_file = keep_df.copy()

# %%
final_file.drop(["Label outcome", "value"], axis=1, inplace=True)

# %%
final_file.columns = ["id", "code"]
...
# %%
final_file = final_file.merge(main_df[["id", "comment"]], on="id", how="left")

# %%
final_file.to_excel(
    f"{project_dir}/outputs/data/multi_label_output_w1.xlsx", index=False
)
